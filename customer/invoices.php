...
if ($viewBookingId > 0) {
    ...
    <div class="btn-row no-print" style="margin-bottom:var(--sp-5)">
    ...
    <div class="invoice">
        <div class="invoice__head">
            ...
            <div class="text-right">
                <dl class="text-small" style="margin:0">
                    <div><dt class="text-muted">Invoice number</dt>
                         <dd style="margin:0" class="ref"><?= e($inv['invoice_no']) ?></dd></div>
                    <div style="margin-top:var(--sp-2)"><dt class="text-muted">Booking</dt>
                         <dd style="margin:0" class="ref"><?= e($inv['booking_code']) ?></dd></div>
                    <div style="margin-top:var(--sp-2)"><dt class="text-muted">Status</dt>
                         <dd style="margin:0"><?= status_badge($inv['payment_status']) ?></dd></div>
                </dl>
            </div>
        </div>
        ...
        <div class="invoice__parties">
            <div>
                ...
                <strong style="color:var(--ink-900)"><?= e($inv['customer_name']) ?></strong><br>
            ...
            <div>
                ...
                <strong style="color:var(--ink-900)"><?= e($inv['provider_name']) ?></strong><br>
        ...
        <div style="margin-top:var(--sp-6);padding-top:var(--sp-4);border-top:1px solid var(--line)">
            ...
            <p class="text-small text-muted" style="margin-top:var(--sp-4)">
...
<div class="grid grid--3" style="margin-bottom:var(--sp-6)">
    <div class="stat stat--success">
        ...
        <div class="stat__value" style="font-size:var(--text-xl)"><?= e(money($totalPaid)) ?></div>
    </div>
    <div class="stat stat--accent">
        <div class="stat__label">Awaiting payment</div>
        <div class="stat__value" style="font-size:var(--text-xl)"><?= e(money($totalPending)) ?></div>
    </div>
